    ...
    >
      ...
      <div className="flex flex-col items-start justify-start pt-16 px-0 pb-0 box-border min-w-[488.2px] max-w-full mq450:pt-[42px] mq450:box-border mq750:min-w-full mq1050:flex-1">
        <div className="flex flex-col items-start justify-start gap-[16px] max-w-full">
          ...
          <h1 className="m-0 relative text-6xl leading-[58px] font-bold font-inherit inline-block max-w-full z-[1] mq450:text-10xl mq450:leading-[35px] mq1050:text-19xl mq1050:leading-[46px]">
            How we raised 34M
          </h1>
          <div className=" relative  text-gray-200 inline-block max-h-[130px] [word-break:break-word] z-[1]">{`The advent of online fundraising platforms and digital payment systems has made it easier for individuals from all walks of life to contribute to causes they care about and have the ability to make their small donations count and go far. Digital donations have expanded the reach of our organisation. `}</div>
          <div className="w-[276px] flex flex-row items-start justify-between gap-[20px] text-5xl">
            <div className="flex flex-col items-start justify-start">
              <div className="relative leading-[160%] font-medium inline-block min-w-[62px] z-[1] mq450:text-lgi mq450:leading-[31px]">
                34M+
              </div>
            ...
            <div className="flex flex-col items-start justify-start">
              <div className="relative leading-[160%] font-medium inline-block min-w-[55px] z-[1] mq450:text-lgi mq450:leading-[31px]">
                400+
              </div>
            ...
            <div className="flex flex-col items-start justify-start">
              <div className="relative leading-[160%] font-medium inline-block min-w-[56px] z-[1] mq450:text-lgi mq450:leading-[31px]">
                15K+
              </div>
